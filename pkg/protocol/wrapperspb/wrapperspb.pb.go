...
var file_wrapperspb_wrapperspb_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x40, 0x5a, 0x3e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x77, 0x72, 0x61,
...
func file_wrapperspb_wrapperspb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wrapperspb_wrapperspb_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_wrapperspb_wrapperspb_proto_msgTypes[8].Exporter = func(v any, i int) any {
