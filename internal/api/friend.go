...
import (
	...
	"github.com/openimsdk/open-im-server/v3/pkg/protocol/relation"
...
func (o *FriendApi) GetFollowerIDs(c *gin.Context) {
	a2r.Call(relation.FriendClient.GetFollowerIDs, o.Client, c)
}

func (o *FriendApi) GetSubscriberIDs(c *gin.Context) {
	a2r.Call(relation.FriendClient.GetSubscriberIDs, o.Client, c)
}

func (o *FriendApi) SubscribeUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.SubscribeUser, o.Client, c)
}

func (o *FriendApi) UnsubscribeUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.UnsubscribeUser, o.Client, c)
}

func (o *FriendApi) FollowUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.FollowUser, o.Client, c)
}

func (o *FriendApi) UnfollowUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.UnfollowUser, o.Client, c)
}

func (o *FriendApi) BlockUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.BlockUser, o.Client, c)
}

func (o *FriendApi) UnblockUser(c *gin.Context) {
	a2r.Call(relation.FriendClient.UnblockUser, o.Client, c)
}
